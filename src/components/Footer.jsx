...
const Footer = () => {
    return (
        <div className="">
            ...
            <footer className=" bg-[#111111] text-white p-10 lg:flex  gap-3 justify-around">
                <div className="text-center lg:text-start lg:py-0 py-10">
                ...
                <div className="text-xs lg:py-0 pb-10">
                    <h4 className='text-2xl font-bold text-center lg:text-start'>LATEST <span className='text-[#ff00dc]'>NEWS</span></h4>
                    <div className="">
                ...
                <div className="text-xs ">
                    <h4 className='text-2xl font-bold text-center lg:text-start'>APPS <span className='text-[#ff00dc]'>$ PLATFORMS</span></h4>
